...
//					registro.setVisible(true);
	...
	public void calcularValor(JDateChooser dateEntrada, JDateChooser dateSalida) {
		if (dateEntrada.getDate() != null && dateSalida.getDate() != null) {
			...
			int dias = -1; // Para que contemos desde el día siguiente
			int noche = 80;
			int valor;
